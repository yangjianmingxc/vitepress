import{_ as s,c as n,o as a,a3 as p}from"./chunks/framework.B4-s0397.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"js-base/任务/任务管理.md","filePath":"js-base/任务/任务管理.md"}'),e={name:"js-base/任务/任务管理.md"},l=p(`<h2 id="任务管理" tabindex="-1">任务管理 <a class="header-anchor" href="#任务管理" aria-label="Permalink to &quot;任务管理&quot;">​</a></h2><p> Js最大的特点就是单线程，也就是说同一时间只能处理一个任务。为了协调事件、用户交互、脚本、UI渲染和网络处理等行为，防止主线程不阻塞，（事件循环）<code>Event Loop</code>的方案应用而生。</p><p>Js处理任务是在等待任务、执行任务、休眠等待新任务中不断循环中，也称这种机制为事件循环。</p><ul><li>主线程中的任务完成后，才会执行任务列队中的任务</li><li>有新任务到来时会将其放入列队，采取先进先执行的策略执行列队中的任务</li><li>比如多个 <code>setTimeout</code> 同时到时间了，就要依次执行</li></ul><p>任务包括<code>script</code>(整体代码)、<code>setTimeout</code>、<code>setInterval</code>、<code>DOM渲染</code>、<code>DOM事件</code>、<code>Promise</code>、<code>XMLHTTPREQUEST</code>等</p><h3 id="分析宏任务与微任务案例" tabindex="-1">分析宏任务与微任务案例 <a class="header-anchor" href="#分析宏任务与微任务案例" aria-label="Permalink to &quot;分析宏任务与微任务案例&quot;">​</a></h3><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>console.log(&#39;hello world&#39;)</span></span>
...
<span class="line"><span>console.log(&#39;script end&#39;)</span></span></code></pre></div>`,29),t=[l];function i(c,o,d,u,h,r){return a(),n("div",null,t)}const b=s(e,[["render",i]]);export{m as __pageData,b as default};
